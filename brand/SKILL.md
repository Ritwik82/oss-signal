...
description: Apply the OSS Signal brand — near-black glass UI, teal waveform accent, magenta abandonment signal, serif headings, sans body, mono micro-labels, corner-mark cards — to any new design.
user-invocable: true
---
...
5. Follow the layout posture: 8px radius, 1px borders, 8px baseline grid, glass cards (white 4% fill + 8px blur + 1px white 8% border), 2px accent L-corners, 8–10px uppercase mono micro-labels, circuit-board hero, one accent per viewport; reserve magenta for alerts and abandonment-risk indicators.
...
- **Palette (dark default):** bg `#0a0a0a`, surface `#121212`, fg `#e0e0e0`, muted `#a0a0a0`, border `#232323`, accent `#00f5d4` (use sparingly), accent-secondary `#ff2d95` (alerts + abandonment risk; light `#c2185b`).
