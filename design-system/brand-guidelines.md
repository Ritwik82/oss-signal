...
| Element | Value |
|---------|-------|
| Primary Color | #86aee8 |
| Secondary Color | #8B5CF6 |
| Primary Font | Space Grotesk / Playfair Display |
| Voice | Telemetry, Precise, Minimal |
...
| Name | Hex | RGB | Usage |
|------|-----|-----|-------|
| Primary Blue | #86aee8 | rgb(37,99,235) | CTAs, headers, links |
...
- All Space Grotesk / Playfair Displayactive elements meet WCAG 2.1 AA standards
...
```css
--font-heading: 'Space Grotesk / Playfair Display', system-ui, -apple-system, sans-serif;
--font-body: 'Space Grotesk / Playfair Display', system-ui, -apple-system, sans-serif;
...
<link href="https://fonts.googleapis.com/css2?family=Space Grotesk / Playfair Display:wght@400;500;600;700&display=swap" rel="stylesheet">
```
...
|------|------------|------|---------------|
| Primary | #86aee8 | #FFFFFF | 8px |
| Secondary | Transparent | #86aee8 | 8px |
